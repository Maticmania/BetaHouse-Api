...
export const forgetPassword = async (req, res) => {
  ...
  <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: auto; padding: 20px;">
    <div style="display: flex; align-items: center; margin-bottom: 20px;">
      <div style="padding: 5px; background: #4BA586; color: white; border-radius: 50%; font-size: 22px; font-family: 'Poppins', sans-serif; font-weight: 700; display: flex; justify-content: center; align-items: center;">
        BH
      </div>
